...
for particle in particles:
    ...
    for region in regions:
        ...
        for metcut in metcuts: 
            ...
            Data  = 'DataMC_' + particle + '_' + region + '_' + metcut + err + 'nj_jetpt20_' + year + 'nJets_drLeptonCleaned_jetpt20nJets_drLeptonCleaned_jetpt20' + 'Datadata'
            DY    = 'DataMC_' + particle + '_' + region + '_' + metcut + err + 'nj_jetpt20_' + year + 'nJets_drLeptonCleaned_jetpt20nJets_drLeptonCleaned_jetpt20' + 'DYstack'
            Sint  = 'DataMC_' + particle + '_' + region + '_' + metcut + err + 'nj_jetpt20_' + year + 'nJets_drLeptonCleaned_jetpt20nJets_drLeptonCleaned_jetpt20' + 'Single tstack'
            TTbar = 'DataMC_' + particle + '_' + region + '_' + metcut + err + 'nj_jetpt20_' + year + 'nJets_drLeptonCleaned_jetpt20nJets_drLeptonCleaned_jetpt20' + 't#bar{t}stack'
            Rare  = 'DataMC_' + particle + '_' + region + '_' + metcut + err + 'nj_jetpt20_' + year + 'nJets_drLeptonCleaned_jetpt20nJets_drLeptonCleaned_jetpt20' + 'Rarestack'
...
for particle in particles:
    for region in regions:
        ...
        with open('normCorretion.txt', 'a+') as sheet:
