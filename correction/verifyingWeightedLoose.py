...
root_file = ROOT.TFile.Open("/uscms/home/arosado/nobackup/YOURWORKINGAREA/CMSSW_10_2_9/src/ZInvisible/Tools/condor/eighth_run/result.root", 'read')
...
for region in regions:
    ...
    Dem = 0
    for particle in particles:
        if particle == 'Electron' and region == 'LowDM':
            continue
